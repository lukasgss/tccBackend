...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240318193700_AddAgeToFoundAnimalUserPreferences")]
    partial class AddAgeToFoundAnimalUserPreferences
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Alerts.UserPreferences.AdoptionUserPreferences", b =>
                {
                    ...
                    b.ToTable("AdoptionUserPreferences", t =>
                        {
                            t.HasCheckConstraint("CK_AdoptionUserPreferences_Gender_Enum", "\"Gender\" BETWEEN 0 AND 2");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Alerts.UserPreferences.FoundAnimalUserPreferences", b =>
                {
                    ...
                    b.ToTable("FoundAnimalUserPreferences", t =>
                        {
                            t.HasCheckConstraint("CK_FoundAnimalUserPreferences_Gender_Enum", "\"Gender\" BETWEEN 0 AND 2");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Alerts.UserPreferences.AdoptionUserPreferences", b =>
                {
                    b.HasOne("Domain.Entities.Age", "Age")
                        ...
                        .HasForeignKey("Domain.Entities.Alerts.UserPreferences.AdoptionUserPreferences", "AgeId");
            ...
            modelBuilder.Entity("Domain.Entities.Alerts.UserPreferences.FoundAnimalUserPreferences", b =>
                {
                    b.HasOne("Domain.Entities.Age", "Age")
                        ...
                        .HasForeignKey("Domain.Entities.Alerts.UserPreferences.FoundAnimalUserPreferences", "AgeId");
