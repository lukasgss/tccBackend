...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251116151621_AddMissingReports")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdoptionAlertNotificationUser", b =>
                {
                    b.Property<long>("AdoptionAlertNotificationsId")
                        .HasColumnType("bigint");

                    b.Property<Guid>("UsersId")
                        .HasColumnType("uuid");

                    b.HasKey("AdoptionAlertNotificationsId", "UsersId");

                    b.HasIndex("UsersId");

                    b.ToTable("AdoptionAlertNotificationUser");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Alerts.AdoptionAlert", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("AdoptionRestrictions")
                        .IsRequired()
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("Domain.Entities.Alerts.Notifications.AdoptionAlertNotification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AdoptionAlertNotifications");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Alerts.UserFavorites.FoundAnimalFavorite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("FoundAnimalFavorites");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Alerts.UserPreferences.AdoptionUserPreferences", b =>
                {
                    ...
                    b.PrimitiveCollection<int[]>("Ages")
                        .HasColumnType("integer[]");

                    b.PrimitiveCollection<int[]>("Genders")
                        .HasColumnType("integer[]");
            ...
            modelBuilder.Entity("Domain.Entities.MissingAnimalReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("MissingReports", t =>
                        {
                            t.HasCheckConstraint("CK_MissingReports_Status_Enum", "\"Status\" BETWEEN 1 AND 4");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.Property<string>("DefaultAdoptionFormUrl")
                        .HasMaxLength(256)
                    ...
                    b.Property<bool>("ReceivesOnlyWhatsAppMessages")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("AdoptionAlertNotificationUser", b =>
                {
                    b.HasOne("Domain.Entities.Alerts.Notifications.AdoptionAlertNotification", null)
                        .WithMany()
                        .HasForeignKey("AdoptionAlertNotificationsId")
            ...
            modelBuilder.Entity("Domain.Entities.Alerts.AdoptionAlert", b =>
                {
                    ...
                    b.OwnsOne("Domain.Common.FileAttachment", "AdoptionForm", b1 =>
                        {
                            b1.Property<Guid>("AdoptionAlertId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("AdoptionAlertId");

                            b1.ToTable("AdoptionAlerts");
